### JCB! Power
# final class UikitLoader (Details)
> namespace: **VDM\Joomla\Componentbuilder\Compiler\Dynamicget**

```uml
@startuml

class UikitLoader << (F,LightGreen) >> #RoyalBlue {
  # Config $config
...
note right of UikitLoader::__construct
  Constructor.

  since: 5.1.2
end note

note right of UikitLoader::get
...
note right of UikitLoader::getUikitComp
...
> Simply use this SPK:
```
Super---e06142b6_d776_45b1_9ba5_45375ed55bbf---Power
```
