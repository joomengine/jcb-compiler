### JCB! Power
# final class CustomJoin (Details)
> namespace: **VDM\Joomla\Componentbuilder\Compiler\Dynamicget**

```uml
@startuml

class CustomJoin << (F,LightGreen) >> #RoyalBlue {
  # Config $config
  ...
  + get(array $gets, string $string, ...) : string
  + check(array $default, array $get, ...) : bool
}

note right of CustomJoin::__construct
  Constructor.
...
note right of CustomJoin::check
...
> Simply use this SPK:
```
Super---d843e033_40bf_46f5_a433_b23d82bae1f3---Power
```
