### JCB! Power
# interface ProviderInterface (Details)
> namespace: **VDM\Joomla\Componentbuilder\Compiler\Interfaces\Architecture\Plugin**

```uml
@startuml

interface ProviderInterface  #Lavender {
  + get(object $plugin) : string
}

note right of ProviderInterface::get
...
> Simply use this SPK:
```
Super---d6ae90a5_44b4_4ce4_aedc_86c90a242912---Power
```
