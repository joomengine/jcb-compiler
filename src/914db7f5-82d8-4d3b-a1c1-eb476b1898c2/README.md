### JCB! Power
# interface ExtensionInterface (Details)
> namespace: **VDM\Joomla\Componentbuilder\Compiler\Interfaces\Architecture\Plugin**

```uml
@startuml

interface ExtensionInterface  #Lavender {
  + get(object $plugin) : string
}

note right of ExtensionInterface::get
...
> Simply use this SPK:
```
Super---914db7f5_82d8_4d3b_a1c1_eb476b1898c2---Power
```
